...
@section('content')
    ...
    <div class="panel" id="basic">
        ...
        <div class="panel-body">
            ...
            <form action="{{route('admin.app-view.store')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <span popover="" data-placement="top" data-trigger="hover"
                          ...
                          title=""><i class="fa fa-question-circle"></i></span>
                    <input id="title_color_code" name="title_color_code" value="{{ old('title_color_code') }}"
                        ...
                        <select id="type" name="type" class="form-control" tabindex="2">
                            ...
                            @foreach($types as $type)
                                <option data-content="{{$type->type_content}}"
                                        value="{{ $type->id }}" {{ (old('type')  == $type->id ? "selected": "") }}>{{ $type->type_title_fa." (".$type->type_title.")" }}</option>
                            @endforeach()
                        </select>
                        @if ($errors->has('type'))
                            <div class="alert alert-danger alert-dismissible" role="alert">
                ...
                <div class="form-group display_none" id="ads_container">
                    <span class="field-force"></span>
                    ...
                    <span popover="" data-placement="top" data-trigger="hover"
                          ...
                          title=""><i class="fa fa-question-circle"></i></span>
                    <select id="ads" class="js-example-basic-multiple" style="width: 100%" name="ads[]" multiple="multiple">
                ...
                <div class="form-group display_none" id="category_container">
                    <span class="field-force"></span>
                ...
                <div class="form-group">
                    ...
                    <input id="description_color_code" name="description_color_code"
                           value="{{ old('description_color_code') }}" tabindex="1" placeholder="رنگ توضیحات"
                           type="text" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input id="background_color_code" name="background_color_code"
                           value="{{ old('background_color_code') }}" tabindex="1" placeholder="رنگ پس زمینه"
                           type="text" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input id="action" name="action"
                           value="{{ old('action') }}" tabindex="1" placeholder="متن دکمه عملیات"
                           type="text" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input id="action_color_code" name="action_color_code"
                           value="{{ old('action_color_code') }}" tabindex="1" placeholder="رنگ دکمه عملیات"
                           type="text" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input id="order" name="order"
                           value="{{ old('order') }}" tabindex="1" placeholder="ترتیب"
                           type="text" class="form-control">
                    @if ($errors->has('order'))
                        <div class="alert alert-danger alert-dismissible" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                ...
                <div class="form-group">
                    ...
                    <span popover="" data-placement="top" data-trigger="hover"
                          ...
                          data-original-title="" title=""><i class="fa fa-question-circle"></i></span>
                    <div class="btn-group" id="status" data-toggle="buttons">
                        <label class="btn btn-default btn-on {{ old('need_space') ? 'active' : '' }}">
                            <input type="radio" value="1" name="need_space" {{ old('need_space') ? 'checked' : '' }}>بله</label>
                        <label class="btn btn-default btn-off {{ !old('need_space') ? 'active' : '' }}">
                            <input type="radio" value="0" name="need_space" {{ !old('need_space') ? 'checked' : '' }}>خیر</label>
                    </div>
