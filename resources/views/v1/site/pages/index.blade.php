        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="{{asset('assets/index/img/slide5.jpg')}}" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{asset('assets/index/img/slide3.jpg')}}" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{asset('assets/index/img/slide4.jpg')}}" alt="Third slide">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="google_ads_container">
                        <img src="{{asset('assets/index/img/google_ads1.png')}}">
                    </div>
                </div>
                <div class="col-lg-6 col-12">
                    <div class="google_ads_container">
                        <img src="{{asset('assets/index/img/google_ads2.png')}}">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <img src="{{ asset('assets/index/img/svg/illustration.svg') }}" alt="" class="svg">
                        </div>
                        ...
                        <div class="cat-places-wrapper">
                            <div class="row">
                                @foreach($topLikeBlogs as $blog)
                                    <div class="category-place-single col-lg-4 col-12">
                                        <figure>
                                            <a href="{{ route('blog.show', ['blog' => $blog->id, 'title' => $blog->title]) }}">
                                                <img src="{{ $blog->logo['standard'] }}" alt="{{ $blog->shortTitle }}">
                                            </a>
                                        </figure>
                                        <div class="normal_caption">
                                            <a href="{{ route('blog.show', ['blog' => $blog->id, 'title' => $blog->title]) }}">
                                                <h5>{{ $blog->shortTitle }}</h5>
                                            </a>
                                        </div>
