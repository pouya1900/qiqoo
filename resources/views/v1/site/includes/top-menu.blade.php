                            ...
                            <div class="logo-wrapper order-lg-0 order-sm-1">
                                <div class="logo logo-top">
                                    <a href="{{ route('index') }}"><img
                                                src="{{ asset('assets/index/img/logo3.png') }}" alt="qiqoo logo"
                                                class="img-fluid"></a>
                                </div>
                                        ...
                                        <div class="offcanvas-menu__contents">
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="{{ route('user.profile', ['user' => Auth::user()->id, 'name' => Auth::user()->url_name]) }}">پروفایل
                                                        من</a></li>
                                                <li>
                                                    <i class="la la-plus-circle"></i>
                                                    <a href="{{ route('ads.create')}}">افزودن آگهی</a></li>
                                                <li>
                                                    <i class="la la-sign-out"></i>
                                                    <a href="{{ route('logout') }}">خروج</a></li>
                                            </ul>
