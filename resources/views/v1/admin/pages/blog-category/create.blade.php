    ...
    <div class="row clearfix">
        ...
        <div class="col-sm-6 breadcrumb-col">
            <ol class="breadcrumb">
                ...
                <li><span>افزودن دسته بندی اخبار</span></li>
            </ol>
        </div>
    </div>
            ...
            <form action="{{ route('admin.blog-category.store' )}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" id="status" data-toggle="buttons">
                        ...
                        <label class="btn btn-default btn-off {{ !old('is_favorite') ? 'active' : '' }}">
                            <input type="radio" value="0" name="is_favorite" {{ !old('is_favorite') ? 'checked' : '' }}>خیر</label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id=order name=order tabindex="3" placeholder="ترتیب نمایش دسته بندی در اپ(اختیاری)" class="form-control">{{ old('order') }}</textarea>
                    @if ($errors->has('order'))
                        <div class="alert alert-danger alert-dismissible" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
