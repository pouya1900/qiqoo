  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title"></h3> <div class="popover-content"></div> <div class="popover-navigation"> <div class="btn-group"> <button class="btn btn-sm btn-default" data-role="prev">&laquo; قبلی</button> <button class="btn btn-sm btn-default" data-role="next">بعدی &raquo;</button> <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">توقف</button> </div> <button class="btn btn-sm btn-default" data-role="end">پایان تور</button> </div> </div>',
      ...
      showStepHelper = (function(_this) {
        return function(e) {
          ...
          showPopoverAndOverlay = function() {
            ...
            return _this._debug("مرحله " + (_this._current + 1) + " از " + _this._options.steps.length);
          };
          if (step.autoscroll) {
