...
@section('content')
    ...
    <div class="row clearfix">
        ...
        <div class="col-sm-6 breadcrumb-col">
            <ol class="breadcrumb">
                ...
                <li><span><a href="{{route('admin.category.index')}}">دسته بندی</a></span></li>
                <li><span>دسته بندی جدید</span></li>
            </ol>
        </div>
    </div>
    ...
    <div class="panel" id="basic">
        <div class="panel-heading b#c6f9ff">
            <i class="fa fa-plus-square-o  sort-hand"></i>دسته بندی جدید
        ...
        <div class="panel-body">
            ...
            <form action="{{route('admin.category.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="title" name="title" value="{{ old('title') }}" tabindex="1" placeholder="عنوان" type="text" class="form-control">
                    @if ($errors->has('title'))
                    ...
                    <div class="form-group">
                        ...
                        <select id="parent_id" name="parent_id" class="form-control" tabindex="2">
                            ...
                            @foreach($allCategories as $cat)
                                <option value="{{ $cat->id }}" {{ (old('parent_id')  == $cat->id ? "selected": "") }}>{{ $cat->shortTitle }}</option>
                            @endforeach()
                        </select>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" tabindex="2" placeholder="توضیحات دسته بندی (اختیاری)" class="form-control">{{ old('description')}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input id="price" name="price" value="{{ old('price') }}" tabindex="3" placeholder="قیمت (رایگان = 0)" type="number" class="form-control">
                    @if ($errors->has('price'))
                        <div class="alert alert-danger alert-dismissible" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="form-group">
                    ...
                    <input id="order" name="order" value="{{ old('order') }}" tabindex="3" placeholder="ترتیب دسته" type="number" class="form-control">
                    @if ($errors->has('order'))
                        <div class="alert alert-danger alert-dismissible" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" id="status" data-toggle="buttons">
                        <label class="btn btn-default btn-on {{ old('is_favorite') ? 'active' : '' }}">
                            <input type="radio" value="1" name="is_favorite" {{ old('is_favorite') ? 'checked' : '' }}>بله</label>
                        <label class="btn btn-default btn-off {{ old('is_favorite') == 0 ? 'active' : '' }}">
                            <input type="radio" value="0" name="is_favorite" {{ old('is_favorite') == 0 ? 'checked' : '' }}>خیر</label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" id="status" data-toggle="buttons">
                        <label class="btn btn-default btn-on {{ old('show_in_home') ? 'active' : '' }}">
                            <input type="radio" value="1" name="show_in_home" {{ old('show_in_home') ? 'checked' : '' }}>بله</label>
                        <label class="btn btn-default btn-off {{ old('show_in_home') == 0 ? 'active' : '' }}">
                            <input type="radio" value="0" name="show_in_home" {{ old('show_in_home') == 0 ? 'checked' : '' }}>خیر</label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" id="status" data-toggle="buttons">
                        <label class="btn btn-default btn-on {{ old('show_in_categories') ? 'active' : '' }}">
                            <input type="radio" value="1" name="show_in_categories" {{ old('show_in_categories') ? 'checked' : '' }}>بله</label>
                        <label class="btn btn-default btn-off {{ old('show_in_categories') == 0 ? 'active' : '' }}">
                            <input type="radio" value="0" name="show_in_categories" {{ old('show_in_categories') == 0 ? 'checked' : '' }}>خیر</label>
                    </div>
