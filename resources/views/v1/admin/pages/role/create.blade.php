...
@section('content')
    ...
    <div class="panel" id="basic">
        <div class="panel-heading b#c6f9ff">
            <i class="fa fa-plus-square-o  sort-hand"></i>دسترسی جدید
        ...
        <div class="panel-body">
            ...
            <form action="{{route('admin.role.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="name" name="name" value="{{ old('name') }}"  placeholder="نام" type="text" class="form-control">
                    @if ($errors->has('name'))
                        <div class="alert alert-danger alert-dismissible" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="form-group">
                        ...
                        <select id="permissions" multiple="multiple" name="permissions[]" class="form-control">
                            @foreach($permissions as $permission)
                                <option value="{{ $permission->id }}" {{ (collect(old('permissions'))->contains($permission->id)  ? "selected": "") }}>{{ $permission->shortTitle }}</option>
                            @endforeach()
                        </select>
