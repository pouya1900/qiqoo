                            ...
                            <div class="panel-body">
                                ...
                                <table id="example" class="table table-condensed table-hover table-striped table-responsive data-table">
                                    ...
                                    <tr>
                                        ...
                                        <th data-column-id="order">سفارش</th>
                                    ...
                                    @foreach($payments as $row)
                                        <tr class="clickable-row" data-url="{{route('admin.payment.show', $row->id)}}">
                                            ...
                                            <td>@if(!empty($row->order))<a href="{{ route('admin.order.show', $row->order->id) }}">جزئیات سفارش</a>@else حذف شده @endif</td>
                                            <td>{{ $row->price_toman }}</td>
                                            <td>{{ $row->trans_id }}</td>
