    ...
    <div class="clearfix">
        ...
        <div class="col-sm-6 breadcrumb-col">
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('admin.message.index')}}">push notification</a></li>
                ...
                <div class="panel" id="basic">
                    ...
                    <div class="panel-body">
                        <div class="well " style="transition: all 0.3s ease 0s;">
                            <a href="{{route('admin.message.create')}}" popover="" class="btn btn-warning well b#52D078" data-placement="top" data-trigger="hover" data-content="برای ایجاد رکورد جدید کلیک کنید" data-original-title="" title="">رکورد جدید</a>
                        </div>
                        @if(count($messages))
                            <div class="panel-body">
                                ...
                                <table id="example" class="table table-condensed table-hover table-striped table-responsive data-table">
                                    ...
                                    <tr>
                                        ...
                                        <th data-column-id="created_at">تاریخ</th>
                                    ...
                                    @foreach($messages as $row)
                                        <tr class="clickable-row" data-url="{{route('admin.message.show', $row->id)}}">
                                            <td>{{ $loop->index+1 }}</td>
                                            <td>{{ $row->shortTitle }}</td>
                                            <td>{{ $row->jalali_admin_created_at }}</td>
                                            <td>
                                                @include('v1.admin.includes.page-table-buttons', [
                                                    'table_show'=>['route' => 'admin.message.show', 'id' => $row->id]
                                                ])
                                            </td>
                                        </tr>
                                    @endforeach
