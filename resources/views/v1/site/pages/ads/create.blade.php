...
@section('og-twitter-html-tags')
    ...
    <title>انتخاب دسته بندی | QiQoo سایت</title>
    ...
    <meta property="og:title" content="انتخاب دسته بندی | QiQoo سایت"/>
    <meta property="og:url" content="{{route('ads.create')}}"/>
    ...
    <meta property=twitter:title content="انتخاب دسته بندی | QiQoo سایت">
    <meta property=twitter:description
          content="اخبار مربوط به نیازمندی ها و آگهی های جدید برای آشنایی با کسب و کارهای مختلف و پیدا کردن مناسب ترین کسب و کار مطابق با نیازمندی شما">
    <meta property=twitter:image content="{{asset('assets/dashboard/img/logo.png')}}">
    <meta property=twitter:site content="{{route('ads.create')}}">

    <link rel="canonical" href="{{route('ads.create')}}">
@endsection
@section('custom_head')
                ...
                <div id="app" class="row">
                        ...
                        <div class="atbd_content_module">
                            ...
                            <div class="atbdb_content_module_contents">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="city_id" name="city_id" class="form-control">
                                        ...
                                        @foreach($countries->first()->cities as $city)
                                            <option
                                                value="{{ $city->id }}" {{ (old('city_id')  == $city->id ? "selected": "") }}>{{ $city->title }}</option>
                                        @endforeach()
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('mobile') }}" name="mobile" type="number"
                                    ...
                                    <div id="social_info_sortable_container">
                                        <div class="directorist atbdp_social_field_wrapper">
                                            <div class="row m-bottom-20" id="social-form-fields">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <input value="{{ old('facebook') }}" id="facebook"
                                                    ...
                                                    <div class="form-group">
                                                        <input value="{{ old('instagram') }}" id="instagram"
                                                    ...
                                                    <div class="form-group">
                                                        <input value="{{ old('twitter') }}" id="twitter" name="twitter"
                                                               type="url"
                                                               class="form-control directory_field atbdp_social_input"
                                                               placeholder="مثال. http://example.com">
                                                    ...
                                                    <div class="form-group">
                                                        <input value="{{ old('youtube') }}" id="youtube" name="youtube"
                                                               type="url"
                                                               class="form-control directory_field atbdp_social_input"
                                                               placeholder="مثال. http://example.com">
                                    ...
                                    <div id="hide_if_no_manual_cor" class="clearfix row m-bottom-30">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ old('lat') }}" type="text" name="lat" id="lat"
                                        ...
                                        <div class="col-sm-6 mt-3 mt-sm-0">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ old('long') }}" type="text" name="long" id="long"
                                                       class="form-control directory_field"
                            ...
                            <div class="atbdb_content_module_contents">
                                ...
                                <p id="load-content-image" class="hide-if-no-js">
                                    <a style="cursor: hand" id="delete-custom-img" class="btn btn-outline-danger hidden"
                                       onclick="loadContentImage()">افزودن تصویر آگهی</a><br>
                                </p>
                    ...
                    <div class="col-lg-10 offset-lg-1 text-center">
                        <div
                            ...
                            <label for="term" class="not_empty custom-control-label">من با تمام شرایط و <a href="{{ route('terms') }}" id="term">ضوابط
                                    موافقم</a></label>
                        </div>
